...
def evaluate(embeds, ratio, idx_train, idx_val, idx_test, label, nb_classes, device, dataset, lr, wd, patience
             , isTest=True):
    ...
    f = open("result_"+dataset+str(patience) + '_' + str(ratio)+".txt", "a")
