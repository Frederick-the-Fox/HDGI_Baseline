...
parser.add_argument('--cuda', action = 'store_true', default=True, help='using cuda')
...
adjs, features, labels, idx_train_list, idx_val_list, idx_test_list = process.load_data()
print('adj:{}'.format(len(adjs)),
      'features:{}'.format(features),
      'labels:{}'.format(labels),
      'idx_train_list:{}'.format(idx_train_list),
    )
...
idx_train = torch.LongTensor(idx_train_list[0])
idx_val = torch.LongTensor(idx_val_list[0])
idx_test = torch.LongTensor(idx_test_list[0])
