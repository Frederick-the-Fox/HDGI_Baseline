...
def load_data(dataset="dblp"):
    ...
    data = pkl.load(open('/home/hangni/WangYC/HDGI-master/data/mydata/{}/{}.pkl'.format(dataset, dataset), "rb"))
    adjs = data['adjs']
    features = data['features']
    labels = data['labels']
    idx_train_list = data['idx_train_list']
    idx_val_list = data['idx_val_list']
    idx_test_list = data['idx_test_list']
    # features = None
    # labels = []
    ...
    # adjs = []
    # for adj_name in ['movie_actor_movie','movie_director_movie','movie_keyword_movie']:
...
#    idx_test = torch.LongTensor(idx_test)
    ...
    return adjs, features, labels, idx_train_list, idx_val_list, idx_test_list
